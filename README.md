...
### What steps need to be taken to run the code contained in this GitHub repository? Think about the steps you did at the beginning of the semester to prepare your machine for class. What does the expected output look like? You can use screenshots of the main windows of the software.
...
![Screenshot A](ScreenshotA/photo.jpg)
...
David Acuña, Luis González-Xochihua
Project description: 
In this game, you play as Carti and navigate a world invaded by Tung Tung Sahur’s in the style of your classic 2D platformers.
Give a brief technical guide to running your code: 
To run this game, you must have at least Java 12/21 installed on your device (Anything else?). 
A person should run the program by opening VS Code and pressing the triangle in the top-right corner, or by pressing “Run” on the “main game class” at the bottom of the class called “MainGame.java,” as it is responsible for starting the game.
...
Known issues: 
We could not manage to add more enemies, and if we tried, we were unable to get them to work with the proper logic as the ones presented in the final version. The one bug that is still in the game is at the end of the level. If the player touches the vertical line of where the flag is, the game will still say “You Won” despite the user not actually touching the flag. 
